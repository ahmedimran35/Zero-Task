...
export const api = {
  ...
  createUser: (data: { email: string; password: string; name: string; role?: string }) => request('/users', { method: 'POST', body: JSON.stringify(data) }),
  ...
  createDocument: (data: Record<string, unknown>) => request('/documents', { method: 'POST', body: JSON.stringify(data) }),
  updateDocument: (id: string, data: Record<string, unknown>) => request(`/documents/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  ...
  createPortfolio: (data: Record<string, unknown>) => request('/portfolios', { method: 'POST', body: JSON.stringify(data) }),
  updatePortfolio: (id: string, data: Record<string, unknown>) => request(`/portfolios/${id}`, { method: 'PUT', body: JSON.stringify(data) }),
  deletePortfolio: (id: string) => request(`/portfolios/${id}`, { method: 'DELETE' }),
  addProjectToPortfolio: (portfolioId: string, projectId: string) => request(`/portfolios/${portfolioId}/projects`, { method: 'POST', body: JSON.stringify({ projectId }) }),
  removeProjectFromPortfolio: (portfolioId: string, projectId: string) => request(`/portfolios/${portfolioId}/projects/${projectId}`, { method: 'DELETE' }),
  ...
  getUserQuota: () => request('/teams/user/quota'),
  useAIQuota: () => request('/teams/user/use', { method: 'POST' }),

  // Teams
  getTeams: () => request('/teams'),
  createTeam: (data: Record<string, unknown>) => request('/teams', { method: 'POST', body: JSON.stringify(data) }),
  getTeam: (id: string) => request(`/teams/${id}`),
  addTeamMember: (teamId: string, data: Record<string, unknown>) => request(`/teams/${teamId}/members`, { method: 'POST', body: JSON.stringify(data) }),
  removeTeamMember: (teamId: string, userId: string) => request(`/teams/${teamId}/members/${userId}`, { method: 'DELETE' }),
  setTeamQuota: (teamId: string, data: Record<string, unknown>) => request(`/teams/${teamId}/quotas`, { method: 'POST', body: JSON.stringify(data) }),
  setUserQuota: (teamId: string, data: Record<string, unknown>) => request(`/teams/${teamId}/quotas/user`, { method: 'POST', body: JSON.stringify(data) }),
